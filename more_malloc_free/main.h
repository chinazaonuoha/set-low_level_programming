...
/**
 * malloc_checked - Allocates memory using malloc and checks for successful allocation
...
/**
 * _calloc - Allocates memory for an array of nmemb elements of size bytes each and initializes it to zero
